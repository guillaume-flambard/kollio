...
- [API](./apps/api/CONTEXT.md): the FastAPI backend; owns the domain model (ideas, iterations, constraints, teams) and the agent graphs.
...
- **API ↔ Web**: shared vocabulary for `Idea`, `Iteration`, `ConstraintAnalysis`, and team roles; the API glossary is canonical when they disagree.
