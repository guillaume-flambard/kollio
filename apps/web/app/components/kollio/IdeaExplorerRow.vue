...
.explorer-row.is-selected::before { position: absolute; z-index: 0; inset: 6px 8px 8px 6px; border-radius: var(--kollio-radius-md); background: color-mix(in srgb, var(--kollio-wash) 24%, transparent); content: ''; }
...
.explorer-row-copy strong { display: block; color: var(--kollio-heading); font-size: var(--kollio-text-lead); font-weight: var(--kollio-weight-display); letter-spacing: -.025em; line-height: 1.25; }
.explorer-row-pitch { display: -webkit-box; overflow: hidden; margin-top: 7px; color: var(--ui-text-muted); font-size: var(--kollio-text-small); line-height: 1.46; -webkit-box-orient: vertical; -webkit-line-clamp: 2; }
.explorer-row-topics { display: flex; overflow: hidden; align-items: center; gap: 0; margin-top: 10px; color: var(--ui-text-muted); font-size: var(--kollio-text-caption); white-space: nowrap; }
...
.explorer-row-realism { font-weight: var(--kollio-weight-strong); color: var(--kollio-active-ink); }
.explorer-row-activity { display: grid; align-content: center; justify-items: start; gap: 5px; color: var(--ui-text-muted); font-size: var(--kollio-text-micro); line-height: 1.25; }
